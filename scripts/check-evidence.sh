...
required_paths=(
  ...
  "docker-compose.bench-limits.yml"
  "nginx/nginx-bench.conf"
  ...
  "src/test/java/com/example/miniseckill/service/impl/RedisRecoveryServiceImplTest.java"
  "src/test/java/com/example/miniseckill/job/StockReconcileJobTest.java"
  "src/test/java/com/example/miniseckill/job/SeckillMessageRetryJobTest.java"
